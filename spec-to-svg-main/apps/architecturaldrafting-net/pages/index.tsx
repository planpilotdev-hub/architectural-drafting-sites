...
export default function Home() {
  return (
    <>
      <SeoHead title="Architectural Drafting Services" description="Professional architectural drafting, fast turnaround." />
      <main style={{ minHeight: '100vh', display: 'grid', placeItems: 'center', padding: 24 }}>
        <div style={{ textAlign: 'center', maxWidth: 700 }}>
          <h1 style={{ fontSize: 36, fontWeight: 700, marginBottom: 16 }}>Architectural Drafting Services</h1>
          <p style={{ color: '#6b7280', marginBottom: 24 }}>
            Precise CAD and drafting support for architects and builders.
          </p>
